...
export OPTS="-st_pc_factor_mat_solver_type mumps    -mat_mumps_icntl_14 100  -pep_target 1 -pep_nev 256"\
...
pushd 2-Spectrum
mpirun -n 1 python -m ibmos.modes_qep $OPTS -pep_target 0.99999+0.0108i | tee v_j${JSTR}_n${NSTR}_log.txt 2>&1
